 ...
 */
public class PolygonColor extends Shape<Color> {
    ...
    public void setPositions(double[][] positions) {
        ...
        super.setWidth(State.NORMAL, new AttributeDouble(maxX-minX));
        super.setHeight(State.NORMAL, new AttributeDouble(maxY-minY));
    }
    ...
    public void draw(Render render) {
        render.fillCustomPolygon(component.getX(), component.getY(), positions, (Color) getValue());
    }
}
