...
public class RectangleColor extends Rectangle {
    ...
    public void draw(Render render) {
        ...
        render.fillRectangle(component.getX()-getPadding(Padding.LEFT), component.getY()-getPadding(Padding.TOP), getWidth()+getPadding(Padding.LEFT)+getPadding(Padding.RIGHT), getHeight()+getPadding(Padding.TOP)+getPadding(Padding.BOTTOM), (Color) background.getValue());
    }
}
